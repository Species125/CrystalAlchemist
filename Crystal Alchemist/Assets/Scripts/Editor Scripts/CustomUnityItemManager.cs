...
public class CustomUnityItemManager : EditorWindow
{
    ...
    {
        CustomUnityItemManager window = (CustomUnityItemManager)GetWindow(typeof(CustomUnityItemManager), true, "Item Creation");
    }
    ...
    private void SetNewItemGroup()
    {
        ...
        this.itemGroupSprite = (Sprite)EditorGUILayout.ObjectField("Item Group Sprite", this.itemGroupSprite, typeof(Sprite), allowSceneObjects: true);
        ...
        if (this.updateUI) this.uiSoundEffect = (AudioClip)EditorGUILayout.ObjectField("UI Sound Effect", this.uiSoundEffect, typeof(AudioClip), allowSceneObjects: true);
        else this.uiSoundEffect = null;
        if (this.canConsume) this.itemShopPrice = (ShopPriceUI)EditorGUILayout.ObjectField("Shop Price UI", this.itemShopPrice, typeof(ShopPriceUI), allowSceneObjects: true);
    ...
    private void CreateItem()
    {
        ...
        if (this.type == CostType.keyItem || this.type == CostType.item)
        {
            if (this.showInInventory)
            {
                ...
                string itemSlotPath = parent + "Item Slot Infos/" + this.folders[this.folderindex] + "/" + slotName + ".asset";
            ...
            if (this.createNewGroup)
            {
                ...
                string groupinfoPath = parent + "Item Infos/Item Group Info/" + this.itemGroupName + " Group Info.asset";
                ...
                string groupPath = parent + "Item Groups/" + this.folders[this.folderindex] + "/" + this.itemGroupName + ".asset";
