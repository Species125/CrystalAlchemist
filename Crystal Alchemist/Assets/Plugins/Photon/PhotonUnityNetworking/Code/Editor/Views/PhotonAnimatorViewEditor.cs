...
namespace Photon.Pun
{
    ...
    public class PhotonAnimatorViewEditor : Editor
    {
        ...
        {
            if (this.m_Controller == null) return null;
        ...
        private void DrawCustomAnimator()
        {
            GUILayout.BeginVertical(GUI.skin.box);
            this.m_Target.m_Animator = (Animator)EditorGUILayout.ObjectField("Animator", this.m_Target.m_Animator, typeof(Animator), allowSceneObjects: true);
            bool create = GUILayout.Button("Update");
            if (create) UpdateValues();
            GUILayout.EndVertical();
        }
        ...
        private bool DoesParameterExist(string name)
        {
            ...
            {
                AnimatorControllerParameter param = this.GetAnimatorControllerParameter(i);
